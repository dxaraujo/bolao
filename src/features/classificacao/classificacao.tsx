            ...
            <Card style={{ marginBottom: '0px' }}>
                ...
                <div className='divplayers'>
                    <div style={{ justifySelf: 'right', alignSelf: 'top' }}>
                        <img alt='avatar' src={customUsers[1] ? customUsers[1].picture : blankavatar} className='player2' width={50} height={50} />
                    </div>
                    <div style={{ justifySelf: 'center', alignSelf: 'top' }}>
                        <img alt='avatar' src={customUsers[0] ? customUsers[0].picture : blankavatar} className='player1' width={50} height={50} />
                    </div>
                    <div style={{ justifySelf: 'left', alignSelf: 'top' }}>
                        <img alt='avatar' src={customUsers[2] ? customUsers[2].picture : blankavatar} className='player3' width={50} height={50} />
                    </div>
                </div>
