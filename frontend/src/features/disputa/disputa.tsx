...
import { Card, CardHeader, CardBody, Table, Row, Input, Alert } from 'reactstrap'
                                            ...
                                            <CardBody>
                                                <div style={{ borderRadius: '8px', overflow: 'hidden', backgroundImage: 'linear-gradient(to right,  rgba(224,224,224,1) 0%,rgba(255,255,255,1) 50%,rgba(224,224,224,1) 100%)'}}>
                                                    <Table responsive borderless>
                                                        <tbody>
                                                            <tr>
                                                                <td style={{verticalAlign: 'middle', textAlign: 'center', width: '100px'}}><img alt='avatar' src={authenticatedUser?.picture?.replace('s96-c', 's200-c')} className='img-avatar' width={75} height={75} referrerPolicy='no-referrer' /></td>
                                                                ...
                                                                <td style={{verticalAlign: 'middle', textAlign: 'center', width: '100px'}}><img alt='avatar' src={user ? user.picture?.replace('s96-c', 's200-c') : blankavatar} className='img-avatar' width={75} height={75} referrerPolicy='no-referrer' /></td>
                                                            </tr>
                                                        </tbody>
                                                    </Table>
                                                </div>	
                                                    ...
                                                    <Table responsive striped borderless>
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th className='text-center'><img alt='avatar' src={authenticatedUser?.picture?.replace('s96-c', 's200-c')} className='img-avatar' width={35} height={35} referrerPolicy='no-referrer' /></th>
                                                                <th className='text-center'><img alt='avatar' src={user ? user.picture?.replace('s96-c', 's200-c') : blankavatar} className='img-avatar' width={35} height={35} referrerPolicy='no-referrer' /></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
